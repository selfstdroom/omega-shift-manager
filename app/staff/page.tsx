...
export default function Page() {
  ...
  useEffect(() => {
    getStaffNotifications(demoStaff.id).then((items) => setUnreadCount(items.filter((item) => !item.is_read).length));
  }, []);
