...
export default function StaffSignupPage() {
  ...
  async function submit(e: FormEvent) {
    ...
    const workplace = workplaces.find((item) => item.id === form.workplace_id);
    if (!workplace) { setMessage('所属事業所を選択してください。'); return; }
