...
export type AssignmentRun = { id: string; company_id: string; executed_by: string; project_id?: string | null; created_at: string };
...
export type AssignmentWarning = 'leader_shortage' | 'people_shortage';
